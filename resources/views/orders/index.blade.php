                                ...
                                <td>
                                    <select name="produk_id[]" id="produk_id" class="form-control produk_id">
                                        ...
                                        @foreach($produk as $produks)
                                            <option data-harga="{{$produks->harga}}"
                                                    value="{{$produks->id}}">{{$produks->namaProduk}}</option>
                                        @endforeach
                                    </select>
                                </td>
                                <td>
...
{{--        var numberofrow = ($('.addMoreProduct tr').length - 0) +1;--}}
{{--        var tr =--}}
{{--            '<tr><td class "no""></td>' + numberofrow + '</td>'+--}}
{{--            '<td><select class="form-control produk_id" name="produk_id[]">' + product +--}}
{{--            '</select></td>' +--}}
...
{{--        var total_amount = (qty * harga) - ((qty * harga * diskon) /100);--}}
{{--        tr.find('total_amount').val(total_amount);--}}
