                  ...
                  <div class="card-body">
                      ...
                      <div class="row">
                          <div class="col-md-6">
                              ...
                              <input type="text" name="namaProduk" class="form-control" placeholder="Nama Produk" value="{{$data->namaProduk}}">
                                  @error('namaProduk')
                          ...
                          <div class="col-md-6">
                              <div class="form-group">
                                  ...
                                  <select name="jenisProduk" class="form-control">
                                      ...
                                      <option value="makananringan" {{ $data->jenisProduk == 'makananringan' ? 'selected' : '' }}>makananringan</option>
                                      <option value="pewangi" {{ $data->jenisProduk == 'pewangi' ? 'selected' : '' }}>pewangi</option>
                                      <option value="bumbumasakan" {{ $data->jenisProduk == 'bumbumasakan' ? 'selected' : '' }}>bumbumasakan</option>
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="number" name="minStok" class="form-control" placeholder="Minimal stok"value="{{$data->minStok}}">
                                  @error('minStok')
                                  <span class="text-danger">{{$message}}</span>
                                  @enderror
                              </div>
                              ...
                              <input type="text" value="{{$data->slug}}" hidden name="id">
                          </div>
